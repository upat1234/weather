...
# This script creates a results file based on the results of the log_reg models being made
...
def main():
    ...
    train_bins = [0] * 10
    best_val_bins = [0] * 10
    with open("log_reg_results_" + str(threshold) + "threshold", 'r') as file:
        i=1
        for line in file:
            if (i-2)%22 == 0:
                acc = float(line[21:-1])
    ...
    with open("log_reg_data_dist_results_" + str(threshold) + "threshold", 'w') as wfile:
